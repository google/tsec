...
let errMsg = 'Do not call Location#assign, as this can lead to XSS.';

/** A rule that bans any use of Location#assign. */
export class Rule extends ConformancePatternRule {
  static readonly RULE_NAME = 'ban-location-assign-properties';
    ...
    super(
        {
          ...
          values: ['Location.prototype.assign'],
          allowlistEntries,
          name: Rule.RULE_NAME,
        },
    );
