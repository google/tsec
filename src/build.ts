...
export function performBuild(args: string[]): number {
  ...
  // sure tsec has a chance to build the project even nothing has been modified
  // since last build. `ts.version` is readonly so we have to cast its type.
  // TODO(b/183717636): Add an additional version suffix to reflect the
  // configurations applied in this tsec run.
  // tslint:disable-next-line:ban-module-namespace-object-escape
